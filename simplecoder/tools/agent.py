...
conversation history and tools access. This lets the main agent delegate
...
class AgentTool(Tool):
    ...
    description = (
        ...
        "The sub-agent has its own context and tools access. Use this for: "
    ...
    def execute(self, task: str) -> str:
        if self._parent_agent is None:
            return "Error: agent tools not initialized (no parent agent)"
